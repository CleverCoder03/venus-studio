  ...
  return (
    <div ref={heroRef} className="w-full px-4">
      <div className="pt-40 md:pt-30 lg:pt-45">
        <div className="text-[19.5vw] leading-[0.8] tracking-tight font-roc-Grotesk-Condensed-bold uppercase w-full text-right md:text-[14vw] md:leading-[0.75]">
          <h1>A committed,</h1>
        ...
        <div className="w-[45%] md:w-[35vw] relative">
          <div id="hero_img_wrapper_1">
            <div className="relative hero_img_1 h-60 md:h-[32vw] overflow-hidden">
              <motion.div initial={{opacity: 0}} animate={{opacity:1}} transition={{ duration: 0.4, ease: [0.83, 0, 0.17, 1] }} ref={heroImgRef1} className="relative w-full h-full">
                <Image
        ...
        <div className="w-[55%] md:w-[40vw] relative -mt-7 md:-mt-[10vw]">
          <div id="hero_img_wrapper_2">
            <div className="relative hero_img_2 h-40 md:h-[25vw] overflow-hidden">
              <motion.div initial={{opacity: 0}} animate={{opacity:1}} transition={{ duration: 0.4, ease: [0.83, 0, 0.17, 1] }} ref={heroImgRef2} className="relative w-full h-full">
                <Image
      ...
      <div className="flex justify-center md:justify-start">
        <div className="relative w-90 md:w-[30vw] md:-mt-[15vw] md:ml-[52vw]">
          <Copy>
            <h1 className="font-playfair-regular text-2xl md:text-[1.3vw]">
