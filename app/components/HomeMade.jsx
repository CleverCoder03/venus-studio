    ...
    <div ref={homemadeRef} className="py-10 px-4">
      <div className="">
        <div className="headline text-center md:text-right">
          <h1>the power of</h1>
          <h1 className="md:text-center md:ml-[10vw]">"HOMEMADE"</h1>
          <h1 className="md:text-center md:mr-[8vw]">For Brands</h1>
        </div>
            ...
            <div className="relative w-90 md:w-[30vw] md:mt-[14vw]">
              <Copy>
                <h1 className="sub-headline text-center">
                  We design custom stories and experiences that are beautiful and intelligent. Our perspective is unique. It relies on the subtle balance between aesthetics and pragmatism.
                </h1>
              </Copy>
            </div>
          </div>
